...
class DecoderRNN(nn.Module):
    def __init__(self, embedding_size, hidden_size, output_size, cell_type=None, dropout=0.1):
        '''
...
if __name__ == "__main__":
    ...
    target_tensor = torch.randn(BATCH_SIZE, MAX_LENGTH)
    decoder_hiddens = torch.ones(1, BATCH_SIZE, HID_DIM)

    decoder = DecoderRNN(embedding_size=EMD_DIM, hidden_size=HID_DIM, output_size=OUT_DIM)
